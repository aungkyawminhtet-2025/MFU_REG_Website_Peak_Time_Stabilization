...
export default function App() {
  ...
  const handleBypassQueue = () => {
    if (activeQueueType === 'pre-reg') {
      setPreRegQueuePosition(0);
      setPreRegEta(0);
    } else if (activeQueueType === 'grades') {
      setGradesQueuePosition(0);
      setGradesEta(0);
    }
    addNotification('Queue bypassed successfully', 'info');
  };
    ...
    >
      ...
      {view === 'exit-exam' && (
        <div className="flex flex-col items-center justify-center py-20 text-center space-y-6">
          ...
          <h2 className="text-xl font-medium text-mfu-text-main">Exit Examination System</h2>

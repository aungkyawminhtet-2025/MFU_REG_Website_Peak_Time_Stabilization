    ...
    <div className="min-h-screen flex flex-col bg-mfu-bg">
      <header className="h-16 bg-white border-b border-mfu-border flex items-center justify-between px-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-bold text-mfu-text-main leading-none tracking-tight">
              PORTAL.MFU
            </h1>
            <p className="text-[10px] text-mfu-text-muted uppercase tracking-[0.2em] font-medium mt-1">
              Registrar System
            </p>
          </div>
        </div>
      ...
      <main className="flex-1 flex items-center justify-center p-6">
        ...
        >
          <h2 className="text-4xl font-medium text-mfu-text-main mb-12">
            Sign In
          </h2>
          ...
          <form onSubmit={handleLogin} className="space-y-6 max-w-sm mx-auto">
            ...
            <div className="text-right">
              <button
                type="button"
                className="text-sm text-mfu-red hover:underline"
              >

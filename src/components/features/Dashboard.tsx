      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[15px] font-bold text-mfu-red bg-red-50 px-2 py-1 rounded uppercase tracking-widest">Semester 2/2025</span>
            </div>
         ...
         <div className="space-y-4 text-xl">
           <h2 className="text-2xl font-medium text-mfu-text-main">Upcoming Deadlines</h2>
           <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
             <div className="mfu-card p-4 flex items-center gap-4 hover:border-mfu-red/30 transition-all cursor-pointer group">
               ...
               <div>
                 ...
                 <p className="text-[15px] text-mfu-text-muted">Academic Year 2/2025</p>
               </div>
             </div>
             <div className="mfu-card p-4 flex items-center gap-4 hover:border-mfu-red/30 transition-all cursor-pointer group">
         ...
         <div className="space-y-4">
           <h2 className="text-2xl font-medium text-mfu-text-main">Academic Calendar</h2>
           ...
           {['Bachelor\'s Degree'].map((degree) => (
             <div key={degree} className="mfu-card overflow-hidden">
               ...
               <div className="p-4 space-y-4">
                         ...
                         <tbody>
                           {items.slice(0, 3).map((item, idx) => (
                             <tr key={idx} className="border-b border-slate-100 last:border-0">
                               <td className="py-2 text-[15px] text-mfu-text-main pr-4">{item.list}</td>
                               <td className="py-2 text-[15px] font-bold text-mfu-red whitespace-nowrap">{item.firstDay}</td>
                             </tr>
                           ))}
                         </tbody>
                       </table>
                 ...
                 <button className="w-full py-2 text-[15px] font-bold text-mfu-text-muted hover:text-mfu-red transition-colors uppercase tracking-widest border-t border-slate-100 pt-3">
                   View Full Calendar
                 </button>
               </div>
             </div>
       ...
       <div className="space-y-6">
         ...
         <div className="mfu-card p-5 space-y-4">
           <h3 className="text-[15px] font-bold text-mfu-text-main flex items-center gap-2 uppercase tracking-widest">
           ...
           <button className="w-full py-2 bg-slate-50 text-[15px] font-bold text-mfu-text-muted rounded hover:bg-slate-100 transition-colors uppercase">
             View Detailed Audit
           </button>
         </div>
         ...
         <div className="grid grid-cols-1 gap-4">
           <div className="mfu-card p-4 space-y-3">
             <div className="flex items-center justify-between">
               <h3 className="text-[15px] font-bold text-mfu-text-main uppercase tracking-widest flex items-center gap-2">
                 <Wallet size={12} className="text-mfu-red" />
                 Finance
               </h3>
               <span className="text-[15px] font-bold text-green-600 bg-green-50 px-1.5 py-0.5 rounded uppercase">Paid</span>
             </div>
           ...
           <div className="mfu-card p-4 space-y-3">
             ...
             <div className="space-y-2">
               <div className="p-2 bg-blue-50/50 rounded border border-blue-100 text-[15px] text-blue-800">
         ...
         <div className="grid grid-cols-2 gap-3">
           <button className="mfu-card p-3 flex flex-col items-center gap-1.5 hover:bg-slate-50 transition-all">
             ...
             <span className="text-[15px] font-bold uppercase">Library</span>
           </button>
           <button className="mfu-card p-3 flex flex-col items-center gap-1.5 hover:bg-slate-50 transition-all">
             <HeartPulse size={16} className="text-mfu-red" />
             <span className="text-[15px] font-bold uppercase">Health</span>
           </button>
           <button className="mfu-card p-3 flex flex-col items-center gap-1.5 hover:bg-slate-50 transition-all">
             <Briefcase size={16} className="text-mfu-red" />
             <span className="text-[15px] font-bold uppercase">Career</span>
           </button>
           <button className="mfu-card p-3 flex flex-col items-center gap-1.5 hover:bg-slate-50 transition-all">
             <BookOpen size={16} className="text-mfu-red" />
             <span className="text-[15px] font-bold uppercase">E-Learning</span>
           </button>
         </div>
       </div>
     </div>

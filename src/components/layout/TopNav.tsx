  ...
  return (
    <header className="h-16 bg-white border-b border-mfu-border flex items-center justify-between px-6 sticky top-0 z-50">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-mfu-text-main leading-none tracking-tight">PORTAL.MFU</h1>
          <p className="text-[12px] text-mfu-text-muted uppercase tracking-[0.2em] font-medium mt-1">Registrar System</p>
        </div>
      </div>

      <div className="flex items-center gap-6">
        <div className="flex items-center gap-4 text-sm font-bold text-mfu-red">
        ...
        <div className="flex items-center gap-3 pl-6 border-l border-mfu-border">
          <div className="text-right">
            <p className="text-sm font-bold text-mfu-red leading-none mb-1">{user?.id}</p>
            <p className="text-[13px] font-medium text-mfu-text-main">{user?.name}</p>
          </div>
